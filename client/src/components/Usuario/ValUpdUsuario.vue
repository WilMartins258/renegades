      ...
      try {
        if (sessionStorage.getItem('ValidUsuario')) {
          ...
          if (dadosUsuario.fotoPerfil) {
            try {
              this.avatarSrc = require(`./images/${sessionStorage.getItem('ValidUsuario')}.${dadosUsuario.fotoPerfil}`);
            } catch (error) {
      ...
      salvarButton.addEventListener("click", async () => {
        ...
        try {
          ...
          const novosDadosUsuario = {
            ...
            idUsuario: sessionStorage.getItem('ValidUsuario'),
      ...
      inativaButton.addEventListener("click", async () => {
        try {
          if (window.confirm("Confirma a inativação do usuário? Essa conta não poderá mais ser acessada.")) {
              await api.put('/usuario/invalidar', {idUsuario: sessionStorage.getItem('ValidUsuario')});
